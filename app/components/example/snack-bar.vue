  ...
  <Page class="page" ref="page">
    ...
    <ScrollView>
      <StackLayout class="hello-world">
        <Button class="btn btn-primary -primary" text="简单示例" @tap="btnSnackBar1" />
        <Button class="btn btn-primary -primary" text="复杂示例" @tap="btnSnackBar2" />
      </StackLayout>
    </ScrollView>
  </Page>
</template>
...
export default {
  ...
  mounted() {},
  methods: {
    btnSnackBar1: function() {
      const snackbars = new SnackBar();
      snackBars.simple('Snackbar', 'red', '#fff', 3, false).then(args => {
