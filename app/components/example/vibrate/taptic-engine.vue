    ...
    <ScrollView>
      <StackLayout class="hello-world">
        ...
        <GridLayout columns="*, 96, 84" rows="auto">
          <Button col="0" text="notification: success" @tap="doNotificationSuccess" class="button button-notification-success"></Button>
...
export default {
  ...
  methods: {
    ...
    doNotificationSuccess() {
      tapticEngine
        .notification({ type: TapticEngineNotificationType.SUCCESS })
    ...
    doNotificationWarning() {
      tapticEngine
        .notification({ type: TapticEngineNotificationType.WARNING })
    ...
    doNotificationError() {
      tapticEngine
        .notification({ type: TapticEngineNotificationType.ERROR })
    ...
    doImpactLight() {
      tapticEngine
        .impact({ style: TapticEngineImpactStyle.LIGHT })
    ...
    doImpactMedium() {
      tapticEngine
        .impact({ style: TapticEngineImpactStyle.MEDIUM })
    ...
    doImpactHeavy() {
      tapticEngine
        .impact({ style: TapticEngineImpactStyle.HEAVY })
