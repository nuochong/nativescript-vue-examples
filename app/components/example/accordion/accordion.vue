      ...
      items: [
        {
          ...
          items: [
            { image: '~/assets/images/accordion/a9ff17db85f8136619feb0d5a200c0e4.png', text: 'Stop' },
            {
              text: 'Drop',
        ...
        },
        {
          ...
          items: [
            { text: 'Drop', image: '~/assets/images/accordion/strider.png' },
            {
              text: 'Drop',
              image: '~/assets/images/accordion/f29.png'
            }
          ]
        }
      ]
