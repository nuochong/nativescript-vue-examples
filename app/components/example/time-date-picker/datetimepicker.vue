    ...
    <ScrollView ref="scrollView">
      <StackLayout class="p-20">
        ...
        <StackLayout :visibility="dateVisibility">
          ...
          <DatePickerField hint="tap to choose" pickerOkText="Approve" pickerCancelText="Reject" pickerTitle="Confirm predefined date selection" pickerDefaultDate="2019/05/15">
          </DatePickerField>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="preferred locale: en_US" class="content"></Label>
          <DatePickerField locale="en_US" hint="select date" pickerOkText="OK" pickerCancelText="Cancel" pickerTitle="Select date"></DatePickerField>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="preferred locale: de_DE" class="content"></Label>
          <DatePickerField locale="de_DE" hint="datum auswählen" pickerOkText="Bestätigen" pickerCancelText="Stornieren" pickerTitle="Datum auswählen"></DatePickerField>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>
        ...
        <StackLayout :visibility="timeVisibility">
          ...
          <Label text="modified picker texts" class="content"></Label>
          <TimePickerField hint="tap to choose" pickerOkText="Approve" pickerCancelText="Reject" pickerTitle="Confirm predefined time selection" pickerDefaultTime="22:00">
          </TimePickerField>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="preferred locale: en_US" class="content"></Label>
          <TimePickerField locale="en_US" hint="select time" pickerOkText="OK" pickerCancelText="Cancel" pickerTitle="Select time"></TimePickerField>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="preferred locale: de_DE" class="content"></Label>
          <TimePickerField locale="de_DE" hint="zeit wählen" pickerOkText="Bestätigen" pickerCancelText="Stornieren" pickerTitle="Zeit wählen"></TimePickerField>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>
        ...
        <StackLayout :visibility="dateTimeVisibility">
          ...
          <Label text="min and max date" class="content"></Label>
          <DateTimePickerFields minDate="2020/02/02" maxDate="2021/02/02" hintDate="tap to select date" hintTime="tap to select time"></DateTimePickerFields>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>
          ...
          <Label text="modified picker texts" class="content"></Label>
          <DateTimePickerFields hintDate="tap to choose date" hintTime="tap to choose time" pickerOkText="Approve" pickerCancelText="Reject"
            pickerTitleDate="Confirm predefined date selection" pickerTitleTime="Confirm predefined time selection" pickerDefaultDate="2019/05/15 22:00" autoPickTime="true">
          </DateTimePickerFields>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="preferred locale: en_US" class="content"></Label>
          <DateTimePickerFields locale="en_US" hintDate="select date" hintTime="select time" pickerOkText="OK" pickerCancelText="Cancel" pickerTitleDate="Select date"
            pickerTitleTime="Select time"></DateTimePickerFields>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="preferred locale: de_DE" class="content"></Label>
          <DateTimePickerFields locale="de_DE" hintDate="datum auswählen" hintTime="zeit wählen" pickerOkText="Bestätigen" pickerCancelText="Stornieren"
            pickerTitleDate="Datum auswählen" pickerTitleTime="Zeit wählen"></DateTimePickerFields>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="custom format" class="content"></Label>
          <DateTimePickerFields date="2019/02/24 01:00" dateFormat="'d': dd MMMM yyyy" timeFormat="'t': HH:mm"></DateTimePickerFields>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>

          <Label text="css applied" class="content"></Label>
          <DateTimePickerFields date="2019/02/24 01:00" class="apply-css" pickerTitleDate="select date" pickerTitleTime="select time"></DateTimePickerFields>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>
          ...
          <DateTimePickerFields hintDate="select date" hintTime="select time" orientation="vertical"></DateTimePickerFields>
          <StackLayout class="hr-light m-10" android:visibility="collapse"></StackLayout>
        </StackLayout>
