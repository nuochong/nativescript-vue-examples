<template>
  ...
  <FlexboxLayout class="card" flexDirection="column" flexWrap="warp" justifyContent="center" alignItems="center" alignContent="center" :class="{'active':(index == active), 'inactive':(index != active)}" @tap="goToPlace(place)">
